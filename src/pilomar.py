...
SUPPORTED_SYSTEMS = ['3/buster/32','4/buster/32','4/bookworm/64','Compute/bookworm/64','5/bookworm/64'] # The software is designed to run under these hardware/os combinations.
